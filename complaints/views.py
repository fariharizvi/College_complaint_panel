...
from .utils import analyze_psychological_state
...
def submit_complaint(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            complaint.stress_score = score
            complaint.emotion_label = emotion
            ...
            messages.success(
                request,
                f"Complaint submitted! Priority assigned: {priority}"
            )
            return redirect('dashboard')
